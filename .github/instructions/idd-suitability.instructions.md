...
The numeric `<!-- is-prerelease-autopilot-suitability: N -->`
...
`<!-- is-prerelease-autopilot-suitability: N -->` authoring
convention:

```markdown
<!-- is-prerelease-triage-verdict: <outcome> -->
```
...
`is-prerelease-triage-verdict` marker. Apply the same
