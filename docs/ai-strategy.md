...
This layout — `AGENTS.md` as the single canonical source, with thin
adapters for tools that need one — was adopted directly from
[kurone-kito/pnpm-project-template](https://github.com/kurone-kito/pnpm-project-template),
rather than evolved locally. See that repository's own `docs/ai-strategy.md`
for the history of how it arrived at this structure.
